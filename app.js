    ...
    return {
        addItem: function(type,des,val){
           ...
           var newItem, ID;
            ...
            //Create new item based based  on 'inc' ie 'exp' type
            if (type === 'exp'){
        ...
        //Calculate the percentage of income what wi spent
...
var UIController = (function (){
    ...
    var DOMstrings = {
        ...
        percemtadLable: '.budget__expenses--percentage',
        container:'.container',
    ...
    return {
        ...
        addListItem: function(obj,type){
                ...
                //Replace the  placeholder text whith some actual data
        ...
        displayBudget: function(obj){
            ...
            document.querySelector(DOMstrings.percemtadLable).textContent = obj.percentage;
            ...
            document.querySelector(DOMstrings.percemtadLable).textContent = '---';
...
var controller = (function(budgetCtrl,UICtrl){
    ...
    var DOM = UICtrl.getDOMstring(); document.querySelector(DOM.inputBtn).addEventListener('click', ctrlAddItem);
    ...
    document.querySelector(DOM.container).addEventListener('click',ctrlDeliteItem);
    ...
    var ctrlDeliteItem = function (event){
        
        var itemID, solitID, type, ID;
